      ...
      const mockCombos: Combo[] = [
        {
          ...
          price: 89000,
          image: 'https://reviewphongtap.com/wp-content/uploads/2022/12/gia-bap-nuoc-cgv-3.png?w=800&h=600&fit=crop&q=80',
        ...
        },
        {
          ...
          price: 159000,
          image: 'https://cellphones.com.vn/sforum/wp-content/uploads/2023/07/gia-bap-nuoc-cgv-1.jpg?w=800&h=600&fit=crop&q=80',
        ...
        },
        {
          ...
          price: 229000,
          image: 'https://www.galaxycine.vn/media/2019/7/3/725x435_1562145236829.jpg?w=800&h=600&fit=crop&q=80',
        ...
        },
        {
          ...
          price: 199000,
          image: 'https://reviewphongtap.com/wp-content/uploads/2022/12/gia-bap-nuoc-cgv-4.png?w=800&h=600&fit=crop&q=80',
        ...
        {combos.map((combo) => {
          ...
          return (
            ...
            >
              <div className="p-4">
                {/* Combo Image */}
                <div className="relative w-full h-40 mb-4 rounded-lg overflow-hidden border border-orange-500/30">
                  {combo.image ? (
                    <Image
                      src={combo.image}
                      alt={combo.name}
