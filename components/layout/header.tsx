...
export function Header() {
  ...
  const staffNavigation = [
    { name: 'Quầy vé', href: '/staff', icon: Ticket },
    { name: 'Đặt vé tại quầy', href: '/staff/counter-booking', icon: Film },
  ]
  ...
  const navigation = user?.role === 'staff' 
    ...
    : [
        ...
        { name: t('nav.cinemas'), href: '/cinemas', icon: MapPin },
        { name: t('nav.promotions'), href: '/promotions', icon: Heart },
      ]
